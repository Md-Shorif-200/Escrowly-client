  ...
  const steps = [
    {
      ...
      description:
        "Create your account with mobile OTP & complete KYC verification to get started securely.",
    ...
    },
    {
      ...
      description:
        "Buyers create new orders and sellers can accept them with transparent details.",
    ...
    },
    {
      ...
      description:
        "Payments are stored safely in Escrow until the order is successfully completed.",
    ...
    },
    {
      ...
      description:
        "Once the order is done, Seller gets payment instantly & Buyer confirms delivery.",
