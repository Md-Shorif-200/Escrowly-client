...
export default function DashboardTable() {
  // স্ট্যাটাস কালার ফাংশন (same as original)
  ...
  return (
    <div className='mb-6'>
      ...
      <div className="mb-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900">My Purchase</h1>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              ...
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <p className="text-sm font-medium text-gray-900">iPhone 14 Pro Max</p>
              ...
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <p className="text-sm font-medium text-gray-900">Nike Air Jordan</p>
              ...
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <p className="text-sm font-medium text-gray-900">Samsung Smart TV 55"</p>
                  <p className="text-xs text-gray-500">Electronics</p>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">1</td>
